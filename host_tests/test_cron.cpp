...
TEST_F(CronUtc, MinDelayGuardSkipsTooSoon)
{
    // now 10:59:30: 11:00:00 is only 30s away (<60), skip to 12:00:00 -> 3630s
    EXPECT_EQ(seconds_until(make_tm(2026, 6, 27, 10, 59, 30), {"0 * *"}), 3630);
}
